...
include('../../config/perhitungan.php');
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Certainty Factor</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=rule">
                    <i class="fas fa-fw fa-table"></i>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="https://ui-avatars.com/api/?name=<?=$_SESSION['nama']?>">
                            </a>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Apakah anda yakin ingin Logout? Jika ya tekan "Logout"</div>
